...
describe('TransactionsCtrl', function() {
    ...
    let deferred;
    let removeDefer;
    let mockTransaction; let mockResource;
    ...
    beforeEach(inject(function($controller, _$q_, _$rootScope_, $mdDialog) {
        ...
        const mockCategories = sinon.stub({getCategories: function() {}});

        const mockBankAccount = sinon.stub({getBankAccount: function() {}, getBankAccountTotal: function() {}, getBankAccountTotalByCategory: function() {}});
    ...
    describe('Load Transactions', function() {
        ...
        it('\'buildItemsList\' function unit test - nominal case', function(done) {
            ...
            const result = ctrl.buildItemsList(data);

            const expectedResult = [
                {'group': 'Décembre 2017', 'dateToDisplay': new Date('2017-12-08T17:05:01.000Z')},
                {'transaction': {'date': '2017-12-08T17:05:01.000Z'}, 'dateToDisplay': new Date('2017-12-08T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2017-12-11T17:05:01.000Z'}, 'dateToDisplay': new Date('2017-12-11T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2017-12-31T17:05:01.000Z'}, 'dateToDisplay': new Date('2017-12-31T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Janvier 2018', 'dateToDisplay': new Date('2018-01-08T17:05:01.000Z')},
                {'transaction': {'date': '2018-01-08T17:05:01.000Z'}, 'dateToDisplay': new Date('2018-01-08T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2018-01-09T17:05:01.000Z'}, 'dateToDisplay': new Date('2018-01-09T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Mars 2018', 'dateToDisplay': new Date('2018-03-01T17:05:01.000Z')},
                {'transaction': {'date': '2018-03-01T17:05:01.000Z'}, 'dateToDisplay': new Date('2018-03-01T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Avril 2018', 'dateToDisplay': new Date('2018-04-08T17:05:01.000Z')},
                {'transaction': {'date': '2018-04-08T17:05:01.000Z'}, 'dateToDisplay': new Date('2018-04-08T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2018-04-08T17:06:01.000Z'}, 'dateToDisplay': new Date('2018-04-08T17:06:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2018-04-09T17:05:01.000Z'}, 'dateToDisplay': new Date('2018-04-09T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Juin 2019', 'dateToDisplay': new Date('2019-06-08T17:05:01.000Z')},
                {'transaction': {'date': '2019-06-08T17:05:01.000Z'}, 'dateToDisplay': new Date('2019-06-08T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2019-06-09T17:05:01.000Z'}, 'dateToDisplay': new Date('2019-06-09T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'transaction': {'date': '2019-06-30T17:05:01.000Z'}, 'dateToDisplay': new Date('2019-06-30T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Juillet 2019', 'dateToDisplay': new Date('2019-07-08T17:05:01.000Z')},
                {'transaction': {'date': '2019-07-08T17:05:01.000Z'}, 'dateToDisplay': new Date('2019-07-08T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Août 2019', 'dateToDisplay': new Date('2019-08-08T17:05:01.000Z')},
                {'transaction': {'date': '2019-08-08T17:05:01.000Z'}, 'dateToDisplay': new Date('2019-08-08T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
                {'group': 'Septembre 2019', 'dateToDisplay': new Date('2019-09-09T17:05:01.000Z')},
                {'transaction': {'date': '2019-09-09T17:05:01.000Z'}, 'dateToDisplay': new Date('2019-09-09T17:05:01.000Z'), 'currentlySaving': false, 'showEdit': false},
            ];
	...
	*/
    describe('encapsulateTransaction', function() {
        it('Encasuplating a transaction should initiate correct properties', function(done) {
            ...
            // Encapsulate
            const item = ctrl.encapsulateTransaction(aTransaction);
