...
const statsCategoryController = angular.module('statsCategoryController', []);
statsCategoryController.controller('StatsCategoryCtrl', ['$scope', 'Stats', 'StatsFilter', '$timeout', function($scope, Stats, StatsFilter, $timeout) {
    const self = this;
